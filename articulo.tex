...
\begin{align}
    I_t &= I_{t-1} + x_t - d_t, & \forall t = 1, \ldots, N \\
    I_t &\geq 0, & \forall t = 1, \ldots, N \\
    x_t &\geq 0, & \forall t = 1, \ldots, N \\
    I_0 &= 0 & \text{(inventario inicial cero)} 
\end{align}
\end{definition}
...
Las formulaciones original (8) y MILP (9)-(14) son equivalentes, es decir:
\begin{enumerate}
...
Richter, K. \& Sombrutzki, M. (2001). The reverse Wagner/Whitin model with variable manufacturing and remanufacturing cost. \emph{International Journal of Production Economics}, 71(1-3), 1-12.
